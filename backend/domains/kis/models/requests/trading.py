# Auto-generated
TRADING_REQUESTS = {'CTRGA011R': {'method': 'GET',
               'query': [{'description': '03 입력',
                          'key': 'INQR_DVSN',
                          'length': 2,
                          'name': '조회구분',
                          'required': True,
 ...
 'CTRP6548R': {'method': 'GET',
               'query': [{'description': '계좌번호 체계(8-2)의 앞 8자리',
                          'key': 'CANO',
                          'length': 8,
                          'name': '종합계좌번호',
                          'required': True,
 ...
 'CTSC0004R': {'method': 'GET',
               'query': [{'key': 'RSVN_ORD_ORD_DT',
                          'length': 8,
                          'name': '예약주문시작일자',
                          'required': True,
                          'type': 'string'},
                         {'key': 'RSVN_ORD_END_DT',
                          ...
                          'required': True,
                          'type': 'string'},
                         {'key': 'RSVN_ORD_SEQ', 'length': 10, 'name': '예약주문순번', 'required': True, 'type': 'string'},
                         {'description': '"00" 입력',
 ...
 'CTSC0008U': {'body': [{'description': '계좌번호 체계(8-2)의 앞 8자리',
                         'key': 'CANO',
                         'length': 8,
                         'name': '종합계좌번호',
                         'required': True,
                        ...
                        {'description': '계좌번호 체계(8-2)의 뒤 2자리',
                         ...
                         'required': True,
                         'type': 'string'},
                        {'key': 'PDNO', 'length': 12, 'name': '종목코드(6자리)', 'required': True, 'type': 'string'},
                        {'description': '주문주식수',
                         'key': 'ORD_QTY',
                         'length': 10,
                         'name': '주문수량',
                        ...
                        {'description': '00 : 지정가\r 01 : 시장가\r 02 : 조건부지정가\r 05 : 장전 시간외',
                         ...
                         'required': True,
                         'type': 'string'},
                        {'description': '[매도매수구분코드 01:매도/02:매수시 사용]\r'
                                        ' 10 : 현금 \r'
                                        ' \r'
                                        ' [매도매수구분코드 01:매도시 사용]\r'
                                        ' 12 : 주식담보대출 \r'
                                        ' 14 : 대여상환\r'
                                        ' 21 : 자기융자신규\r'
                                        ' 22 : 유통대주신규\r'
                         ...
                         'required': True,
                         'type': 'string'},
                        {'key': 'LOAN_DT', 'length': 8, 'name': '대출일자', 'required': False, 'type': 'string'},
                        {'description': '(YYYYMMDD) 현재 일자보다 이후로 설정해야 함\r'
                                        ' * RSVN_ORD_END_DT(예약주문종료일자)를 안 넣으면 다음날 주문처리되고 예약주문은 종료됨\r'
                         ...
                         'required': False,
                         'type': 'string'},
                        {'key': 'LDNG_DT', 'length': 8, 'name': '대여일자', 'required': False, 'type': 'string'}],
               'method': 'POST',
               'title': '주식예약주문',
               'tr_id': 'CTSC0008U',
               'url': '/uapi/domestic-stock/v1/trading/order-resv'},
 'CTSC0009U': {'body': [{'description': '[정정/취소] 계좌번호 체계(8-2)의 앞 8자리',
                         'key': 'CANO',
                         'length': 8,
                         'name': '종합계좌번호',
                         'required': True,
 ...
 'CTSC0013U': {'body': [{'description': '[정정/취소] 계좌번호 체계(8-2)의 앞 8자리',
                         'key': 'CANO',
                         'length': 8,
                         'name': '종합계좌번호',
                         'required': True,
 ...
 'CTSC9215R': {'method': 'GET',
               'query': [{'description': '계좌번호 체계(8-2)의 앞 8자리',
                         ...
                         {'description': "'00 전체\r"
                          ...
                          'required': True,
                          'type': 'string'},
                         {'description': '한국거래소 : KRX\r'
                                         ' 대체거래소 (NXT) : NXT\r'
                                         ' SOR (Smart Order Routing) : SOR\r'
                                         ' ALL : 전체\r'
                                         ' ※ 모의투자는 KRX만 제공',
                          'key': 'EXCG_ID_DVSN_CD',
                          'length': 3,
 ...
 'FHKST17010000': {'method': 'GET',
                   'query': [{'description': 'Unique key(11701)',
                             ...
                             {'description': '시장구분코드 (주식 J)',
                              ...
                              'required': True,
                              'type': 'string'},
                             {'description': "'(융자)0:잔고비율 상위, 1: 잔고수량 상위, 2: 잔고금액 상위, 3: 잔고비율 증가상위, 4: 잔고비율 감소상위 \r"
 ...
 'FHPST01720000': {'method': 'GET',
                   'query': [{'description': '입력값 없을때 전체 (거래량 ~)',
                              'key': 'fid_vol_cnt',
                              'length': 12,
                              'name': '거래량 수',
                              'required': True,
 ...
 'TTTC0011U': {'body': [{'description': '종합계좌번호',
                         'key': 'CANO',
                         'length': 8,
                         'name': '종합계좌번호',
                         'required': True,
                        ...
                        {'description': '[KRX]\r'
                                        ...
                                        ' 06 : 장후 시간외\r'
                                        ' 07 : 시간외 단일가\r'
                                        ' 11 : IOC지정가 (즉시체결,잔량취소)\r'
                                        ' 12 : FOK지정가 (즉시체결,전량취소)\r'
                                        ' 13 : IOC시장가 (즉시체결,잔량취소)\r'
                                        ' 14 : FOK시장가 (즉시체결,전량취소)\r'
                                        ' 15 : IOC최유리 (즉시체결,잔량취소)\r'
                                        ' 16 : FOK최유리 (즉시체결,전량취소)\r'
                                        ' 21 : 중간가\r'
                                        ' 22 : 스톱지정가\r'
                                        ' 23 : 중간가IOC\r'
                                        ' 24 : 중간가FOK\r'
 ...
 'TTTC0012U': {'body': [{'description': '종합계좌번호',
                         'key': 'CANO',
                         'length': 8,
                         'name': '종합계좌번호',
                         'required': True,
               ...
               'tr_id': 'TTTC0012U',
               'url': '/uapi/domestic-stock/v1/trading/order-cash'},
 'TTTC0013U': {'body': [{'description': '종합계좌번호',
                         'key': 'CANO',
                         'length': 8,
                         'name': '종합계좌번호',
                         'required': True,
 ...
 'TTTC0051U': {'body': [{'description': '계좌번호 체계(8-2)의 앞 8자리',
                         'key': 'CANO',
                         'length': 8,
                         'name': '종합계좌번호',
                         'required': True,
                        ...
                        {'description': '공란 입력',
                         ...
                         'required': False,
                         'type': 'string'},
                        {'description': '[매도] 22 : 유통대주신규, 24 : 자기대주신규, 25 : 자기융자상환, 27 : 유통융자상환\r'
                        ...
                        {'description': '[KRX]\r'
                         ...
                         'required': True,
                         'type': 'string'},
                        {'key': 'ORD_QTY', 'length': 2, 'name': '주문수량', 'required': True, 'type': 'string'},
                        {'description': '1주당 가격 \r * 장전 시간외, 장후 시간외, 시장가의 경우 1주당 가격을 공란으로 비우지 않음 "0"으로 입력 권고',
                         ...
                         'required': True,
                         'type': 'string'},
                        {'description': '정규 증권시장이 열리지 않는 시간 (15:10분 ~ 익일 7:30분) 에 주문을 미리 설정 하여 다음 영업일 또는 설정한 기간 동안 아침 '
                                        '동시 호가에 주문하는 것 \r'
                                        ' Y : 예약주문 \r'
                                        ' N : 신용주문',
                         'key': 'RSVN_ORD_YN',
                         ...
                         'required': False,
                         'type': 'string'},
                        {'key': 'EMGC_ORD_YN', 'length': 2, 'name': '비상주문여부', 'required': False, 'type': 'string'},
                        {'key': 'PGTR_DVSN', 'length': 10, 'name': '프로그램매매구분', 'required': False, 'type': 'string'},
                        {'key': 'MGCO_APTM_ODNO',
                         'length': 19,
                         'name': '운용사지정주문번호',
                         'required': False,
                        ...
                        {'key': 'LQTY_TR_NGTN_ID',
                         ...
                         'required': False,
                         'type': 'string'},
                        {'key': 'LP_ORD_YN', 'length': 3, 'name': 'LP주문여부', 'required': False, 'type': 'string'},
                        {'key': 'MDIA_ODNO', 'length': 10, 'name': '매체주문번호', 'required': False, 'type': 'string'},
                        {'key': 'ORD_SVR_DVSN_CD',
                         'length': 19,
                         'name': '주문서버구분코드',
                         'required': False,
                        ...
                        {'key': 'CVRG_SLCT_RSON_CD',
                         ...
                         'required': False,
                         'type': 'string'},
                        {'key': 'CVRG_SEQ', 'length': 19, 'name': '반대매매순번', 'required': False, 'type': 'string'},
                        {'description': '한국거래소 : KRX\r'
                                        ' 대체거래소 (넥스트레이드) : NXT\r'
                                        ' SOR (Smart Order Routing) : SOR\r'
                                        ' → 미입력시 KRX로 진행되며, 모의투자는 KRX만 가능',
 ...
 'TTTC0052U': {'body': [{'description': '계좌번호 체계(8-2)의 앞 8자리',
                         'key': 'CANO',
                         'length': 8,
                         'name': '종합계좌번호',
                         'required': True,
 ...
 'TTTC0503R': {'method': 'GET',
               'query': [{'key': 'CANO', 'length': 8, 'name': '종합계좌번호', 'required': True, 'type': 'string'},
                         {'description': '29',
                          'key': 'ACNT_PRDT_CD',
                          'length': 2,
                          'name': '계좌상품코드',
                          'required': True,
                          'type': 'string'},
                         {'key': 'PDNO', 'length': 12, 'name': '상품번호', 'required': True, 'type': 'string'},
                         {'description': '00',
                          'key': 'ACCA_DVSN_CD',
                          'length': 2,
                          'name': '적립금구분코드',
                         ...
                         {'description': '00 : 지정가 / 01 : 시장가',
                          ...
                          'required': True,
                          'type': 'string'},
                         {'key': 'ORD_UNPR', 'length': 19, 'name': '주문단가', 'required': True, 'type': 'string'}],
               'title': '퇴직연금 매수가능조회',
               'tr_id': 'TTTC0503R',
               'url': '/uapi/domestic-stock/v1/trading/pension/inquire-psbl-order'},
 'TTTC0506R': {'method': 'GET',
               'query': [{'key': 'CANO', 'length': 8, 'name': '종합계좌번호', 'required': True, 'type': 'string'},
                         {'description': '29',
                          'key': 'ACNT_PRDT_CD',
                          'length': 2,
 ...
 'TTTC2210R': {'method': 'GET',
               ...
               'tr_id': 'TTTC2210R',
               'url': '/uapi/domestic-stock/v1/trading/pension/inquire-daily-ccld'},
 'TTTC8408R': {'method': 'GET',
               'query': [{'description': '종합계좌번호',
                          'key': 'CANO',
                          'length': 8,
                          'name': '종합계좌번호',
                          'required': True,
 ...
 'TTTC8494R': {'method': 'GET',
               'query': [{'description': '계좌번호 체계(8-2)의 앞 8자리',
                         ...
                         {'description': '00 : 전일매매포함 \r 01 : 전일매매미포함',
                          ...
                          'required': True,
                          'type': 'string'},
                         {'key': 'COST_ICLD_YN', 'length': 1, 'name': '비용포함여부', 'required': True, 'type': 'string'},
                         {'description': '공란 : 최초 조회시 \r 이전 조회 Output CTX_AREA_FK100 값 : 다음페이지 조회시(2번째부터)',
                          'key': 'CTX_AREA_FK100',
                          'length': 100,
                          'name': '연속조회검색조건100',
 ...
 'TTTC8708R': {'method': 'GET',
               'query': [{'key': 'ACNT_PRDT_CD', 'length': 2, 'name': '계좌상품코드', 'required': True, 'type': 'string'},
                         {'key': 'CANO', 'length': 8, 'name': '종합계좌번호', 'required': True, 'type': 'string'},
                         {'key': 'INQR_STRT_DT', 'length': 8, 'name': '조회시작일자', 'required': True, 'type': 'string'},
                         ...
                         {'key': 'CTX_AREA_NK100',
                          ...
                          'required': True,
                          'type': 'string'},
                         {'key': 'INQR_END_DT', 'length': 8, 'name': '조회종료일자', 'required': True, 'type': 'string'},
 ...
 'TTTC8715R': {'method': 'GET',
               'query': [{'key': 'CANO', 'length': 8, 'name': '종합계좌번호', 'required': True, 'type': 'string'},
                         {'description': '00: 최근 순, 01: 과거 순, 02: 최근 순',
                          ...
                          'required': True,
                          'type': 'string'},
                         {'key': 'ACNT_PRDT_CD', 'length': 2, 'name': '계좌상품코드', 'required': True, 'type': 'string'},
                         {'description': '""공란입력 시, 전체',
                          'key': 'PDNO',
                          'length': 12,
                          'name': '상품번호',
 ...
 'TTTC8908R': {'method': 'GET',
               'query': [{'description': '계좌번호 체계(8-2)의 앞 8자리',
                         ...
                         {'description': '종목번호(6자리)\r * PDNO, ORD_UNPR 공란 입력 시, 매수수량 없이 매수금액만 조회됨',
                          ...
                          'required': True,
                          'type': 'string'},
                         {'description': '1주당 가격\r'
                                         ' * 시장가(ORD_DVSN:01)로 조회 시, 공란으로 입력\r'
                          ...
                          'required': True,
                          'type': 'string'},
                         {'description': '* 특정 종목 전량매수 시 가능수량을 확인할 경우\r'
                                         '     00:지정가는 증거금율이 반영되지 않으므로\r'
                                         '     증거금율이 반영되는 01: 시장가로 조회\r'
                                         ' * 다만, 조건부지정가 등 특정 주문구분(ex.IOC)으로 주문 시 가능수량을 확인할 경우 주문 시와 동일한 주문구분(ex.IOC) '
                                         '입력하여 가능수량 확인\r'
                                         ' * 종목별 매수가능수량 조회 없이 매수금액만 조회하고자 할 경우 임의값(00) 입력\r'
                                         ' 00 : 지정가\r'
                                         ' 01 : 시장가\r'
                                         ' 02 : 조건부지정가\r'
                                         ' 03 : 최유리지정가\r'
