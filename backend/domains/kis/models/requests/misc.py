# Auto-generated
MISC_REQUESTS = {   'FHKST11860000': {   'method': 'GET',
    ...
    'FHKST17010000': {   'method': 'GET',
                         'query': [   {   'description': 'Unique key(11701)',
                                          ...
                                          'required': True,
                                          'type': 'string'},
                                      {   'description': '0000:전체, 0001:거래소, 1001:코스닥, '
                                                         '2001:코스피200,',
                                          'key': 'FID_INPUT_ISCD',
                                          'length': 12,
                                          'name': '입력 종목코드',
                                      ...
                                      {   'description': '시장구분코드 (주식 J)',
                                          ...
                                          'required': True,
                                          'type': 'string'},
                                      {   'description': "'(융자)0:잔고비율 상위, 1: 잔고수량 상위, 2: 잔고금액 상위, "
                                                         '3: 잔고비율 증가상위, 4: 잔고비율 감소상위 \r'
                                                         ' (대주)5:잔고비율 상위, 6: 잔고수량 상위, 7: 잔고금액 상위, '
                                                         "8: 잔고비율 증가상위, 9: 잔고비율 감소상위 '",
                                          'key': 'FID_RANK_SORT_CLS_CODE',
                                          'length': 2,
                                          'name': '순위 정렬 구분 코드',
                                          'required': True,
    ...
    'FHPST01700000': {   'method': 'GET',
                         'query': [   {   'description': '공백 입력 시 전체 (~ 비율',
                                      ...
                                      {   'description': 'Unique key( 20170 )',
                                          ...
                                          'required': True,
                                          'type': 'string'},
                                      {   'description': '0000(전체) 코스피(0001), 코스닥(1001), '
                                                         '코스피200(2001)',
                                          'key': 'fid_input_iscd',
                                          'length': 12,
                                          'name': '입력 종목코드',
                                      ...
                                      {   'description': '0:전체 , 누적일수 입력',
                                          ...
                                          'required': True,
                                          'type': 'string'},
                                      {   'description': "'fid_rank_sort_cls_code :0 상승율 순일때 "
                                                         '(0:저가대비, 1:종가대비)\r'
                                                         ' fid_rank_sort_cls_code :1 하락율 순일때 '
                                                         '(0:고가대비, 1:종가대비)\r'
    ...
    'FHPST01730000': {   'method': 'GET',
                         'query': [   {   'description': '시장구분코드 (J:KRX, NX:NXT)',
                                      ...
                                      {   'description': '0: 1/4분기 , 1: 반기, 2: 3/4분기, 3: 결산',
                                          ...
                                          'required': True,
                                          'type': 'string'},
                                      {   'description': '0:매출이익 1:영업이익 2:경상이익 3:당기순이익 4:자산총계 '
                                                         '5:부채총계 6:자본총계',
                                          'key': 'fid_rank_sort_cls_code',
                                          'length': 2,
                                          'name': '순위 정렬 구분 코드',
    ...
    'FHPST01750000': {   'method': 'GET',
                         'query': [   {   'description': '0 : 전체',
                                      ...
                                      {   'description': '0: 1/4분기 , 1: 반기, 2: 3/4분기, 3: 결산',
                                          ...
                                          'required': True,
                                          'type': 'string'},
                                      {   'description': '7: 수익성 분석, 11 : 안정성 분석, 15: 성장성 분석, 20: '
                                                         '활동성 분석',
                                          'key': 'fid_rank_sort_cls_code',
                                          'length': 2,
                                          'name': '순위 정렬 구분 코드',
    ...
    'FHPST01780000': {   'method': 'GET',
                         'query': [   {   'description': '입력값 없을때 전체 (~ 가격)',
                                      ...
                                      {   'description': 'Unique key( 20178 )',
                                          ...
                                          'required': True,
                                          'type': 'string'},
                                      {   'description': '0: 전체, 1:관리종목, 2:투자주의, 3:투자경고, 4:투자위험예고, '
                                                         '5:투자위험, 6:보톧주, 7:우선주',
                                          'key': 'fid_div_cls_code',
                                          'length': 2,
                                          'name': '분류 구분 코드',
                                      ...
                                      {   'description': '0: 이격도상위순, 1:이격도하위순',
                                          ...
                                          'required': True,
                                          'type': 'string'},
                                      {   'description': '5:이격도5, 10:이격도10, 20:이격도20, 60:이격도60, '
                                                         '120:이격도120',
    ...
    'FHPST01790000': {   'method': 'GET',
                         'query': [   {   'description': '0 : 전체',
                                      ...
                                      {   'description': '0: 1/4분기 , 1: 반기, 2: 3/4분기, 3: 결산',
                                          ...
                                          'required': True,
                                          'type': 'string'},
                                      {   'description': "'가치분석(23:PER, 24:PBR, 25:PCR, 26:PSR, "
                                                         '27: EPS, 28:EVA,\r'
                                                         ' 29: EBITDA, 30: EV/EBITDA, '
                                                         "31:EBITDA/금융비율'",
                                          'key': 'fid_rank_sort_cls_code',
                                          'length': 2,
                                          'name': '순위 정렬 구분 코드',
    ...
    'FHPST04820000': {   'method': 'GET',
                         'query': [   {   'description': '공백',
                                      ...
                                      {   'description': 'Unique key(20482)',
                                          ...
                                          'type': 'string'},
                                      {   'description': '0000:전체, 0001:코스피, 1001:코스닥, '
                                                         '2001:코스피200, 4001: KRX100, 3003: 코스닥150',
                                          'key': 'FID_INPUT_ISCD',
                                          'length': 12,
                                          'name': '입력 종목코드',
                                          'required': True,
                                      ...
                                      {   'description': "'조회가간(일수):\r"
                                                         ' 조회구분(D) 0:1일, 1:2일, 2:3일, 3:4일, 4:1주일, '
                                                         '9:2주일, 14:3주일, \r'
    ...
    'H0EWANC0': {   'body': [   {   'description': 'H0EWANC0',
                                    'key': 'tr_id',
                                    'length': 2,
                                    'name': '거래ID',
                                    'required': True,
                                ...
                                {   'description': 'ELW 종목코드(ex. 57LA24)',
                                    ...
                                    'required': True,
                                    'type': 'string'}],
                    'header': [   {   'description': '실시간 (웹소켓) 접속키 발급 API(/oauth2/Approval)를 사용하여 '
                                                     '발급받은 웹소켓 접속키',
                                      'key': 'approval_key',
                                      'length': 36,
                                      'name': '웹소켓 접속키',
    ...
    'H0STCNI0': {   'body': [   {   'description': "'[실전/모의투자]\r"
                                                   ' H0STCNI0 : 국내주식 실시간체결통보\r'
    ...
    'HHKDB13470100': {   'method': 'GET',
                         'query': [   {   'description': '공백',
                                      ...
                                      {   'description': "'코스피(0001:종합, 0002:대형주.…0027:제조업 ), \r"
                                                         ...
                                                         ' 코스피200 (2001:KOSPI200, 2007:KOSPI100, '
                                                         "2008:KOSPI50)'",
                                          'key': 'UPJONG',
                                          'length': 4,
                                          'name': '업종구분',
